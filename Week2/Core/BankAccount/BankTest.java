public class BankTest {
    public static void main(String[] args){
        ...
        double newCheckingBalance = bankaccount1.deposit(1500, "checking");
        double newSavingsBalance = bankaccount1.deposit(500, "savings");
        System.out.println("newCheckingBalance = " + newCheckingBalance);
        System.out.println("newSavingsBalance = " + newSavingsBalance);
    
        // Second bank account
        double newCheckingBalance2 = bankaccount2.deposit(500, "checking");
        double newSavingsBalance2 = bankaccount2.deposit(500, "savings");
        ...
        double withdrawCheckingBalance = bankaccount1.withdraw(1500, "checking");
        double withdrawSavingsBalance = bankaccount1.withdraw(500, "savings");
        ...
        // Second bank account
        double withdrawCheckingBalance2 = bankaccount2.withdraw(700, "checking");
        double withdrawSavingsBalance2 = bankaccount2.withdraw(500, "savings");
